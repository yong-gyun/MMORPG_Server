...
namespace DummyClient
{
    ...
    public class ServerSession : Session
    {
        public override void OnConnected(EndPoint endPoint)
        {
            ...
            packet.skills.Add(new PlayerInfoReq.Skill() { id = 101, level = 1, duration = 2.0f });
            packet.skills.Add(new PlayerInfoReq.Skill() { id = 102, level = 3, duration = 6.0f });
            packet.skills.Add(new PlayerInfoReq.Skill() { id = 103, level = 2, duration = 4.0f });
            packet.skills.Add(new PlayerInfoReq.Skill() { id = 104, level = 4, duration = 8.0f });
            //for (int i = 0; i < 5; i++)
            {
